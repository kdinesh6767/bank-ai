...
alway give answer with normal human way and dont add the account id details.
"""

SQL_PREFIX = SQL_PREFIX.format(account_id=2)
...
agent_executor.run("what is the balance ammount")